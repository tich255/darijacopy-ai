...
مهمتك هي كتابة 2 نصوص إعلانية احترافية وجذابة لمنتج معين بالدارجة المغربية المفهومة والمكتوبة بحروف عربية صلبة.
...
1. النص الإعلاني الأول: يجب أن يكون بأسلوب حماسي، سريع، ومباشر يركز على حل مشكلة حقيقية يعاني منها المستهلك (Problem-Solution Framework).
2. النص الإعلاني الثاني: يجب أن يكون بأسلوب قصة مشوقة (Storytelling) قريبة من المعيش اليومي للمواطن المغربي العادي ليتمكن من التفاعل معها عاطفياً.
3. اللغة: دارجة مغربية بيضاء مفهومة ومؤثرة، مكتوبة بالخط العربي. تجنب العروبية القاسية وتجنب الكلمات الفرنسية المعقدة إلا إذا كانت متداولة شعبياً في التجارة (مثل: لافاج، طوموبيل، السيرفيت، الشارجور).
4. التنسيق: استخدم علامات الوقف، الإيموجيز المناسبة لجذب الانتباه بصرياً، واقسم النص إلى فقرات قصيرة سهلة القراءة.
5. طلب اتخاذ إجراء (Call to Action): يجب إنهاء كل إعلان بـ CTA واضح وقوي ومحفز للضغط والشراء الفوري (مثال: اضغط على الرابط دابا واستافد من التوصيل فابور والدفع عند الاستلام!).
